...
ADMIN_USER_ID = 6485336955  # Replace with the actual admin user ID
...
def handle_message(message):
    if message.text == "":
        ...
        if user_data:
            ...
            response = "*No account information found. Please contact the administrator.@MoinOwner*"
        bot.reply_to(message, response, parse_mode='Markdown')
    elif message.text == "HElP ☠️":
        bot.reply_to(message, "*DM--> @MoinOwner*", parse_mode='Markdown')
